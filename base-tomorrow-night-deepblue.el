...
names to which it refers are bound."
  (quote
   `(;; Standard font lock faces
     ...
     (diff-refine-added ((,class (:foreground ,aqua))))
     ...
     (ediff-current-diff-A ((,class (:foreground ,comment :background ,highlight :extend t))))
     (ediff-current-diff-Ancestor ((,class (:foreground ,aqua :background ,highlight))))
     (ediff-current-diff-B ((,class (:foreground ,comment :background ,highlight :extend t))))
     (ediff-current-diff-C ((,class (:foreground ,comment :background ,highlight :extend t))))
     ...
     (outline-2 ((,class (:inherit nil :foreground ,orange))))
     (outline-3 ((,class (:inherit nil :foreground ,green))))
     (outline-4 ((,class (:inherit nil :foreground ,purple))))
     (outline-5 ((,class (:inherit nil :foreground ,red))))
     (outline-6 ((,class (:inherit nil :foreground ,yellow))))
