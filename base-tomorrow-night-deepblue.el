...
names to which it refers are bound."
  (quote
   `(;; Standard font lock faces
     ...
     ;; (font-lock-delimiter-face ((,class (:foreground ,purple))))
     ...
     (outline-1 ((,class (:inherit nil :foreground ,red))))
     (outline-2 ((,class (:inherit nil :foreground ,orange))))
     (outline-3 ((,class (:inherit nil :foreground ,green))))
     (outline-4 ((,class (:inherit nil :foreground ,blue))))
     (outline-5 ((,class (:inherit nil :foreground ,purple))))
