...
- If you like the way Vim tabs look, you can make Emacs tab-bar look like Vim's tab bar using the [vim-tab-bar.el](https://github.com/jamescherti/vim-tab-bar.el) Emacs package.
