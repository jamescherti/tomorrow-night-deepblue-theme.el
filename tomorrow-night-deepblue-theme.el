...
(quote
 `(;; Standard font lock faces
   ...
   (markdown-code-face ((,class (:foreground ,foreground :background ,darkblue :extend t))))
   ...
   (org-block-begin-line ((,class (:foreground ,blue :background ,darkblue :extend t))))
   (org-block-end-line ((,class (:foreground ,blue :background ,darkblue :extend t))))
   (org-code ((,class (:foreground ,yellow :background ,darkblue))))
