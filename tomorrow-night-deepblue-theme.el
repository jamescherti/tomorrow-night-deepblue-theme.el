...
names to which it refers are bound."
  (quote
   `(;; Standard font lock faces
     ...
     (gnus-group-mail-1-empty ((,class (:foreground ,comment :weight normal))))
     (gnus-group-mail-2 ((,class (:foreground ,purple :weight normal))))
     (gnus-group-mail-2-empty ((,class (:foreground ,comment :weight normal))))
     (gnus-group-mail-3 ((,class (:foreground ,aqua :weight normal))))
     (gnus-group-mail-3-empty ((,class (:foreground ,comment :weight normal))))
     (gnus-group-mail-4 ((,class (:foreground ,yellow :weight normal))))
     (gnus-group-mail-4-empty ((,class (:foreground ,comment :weight normal))))
     (gnus-group-mail-5 ((,class (:foreground ,orange :weight normal))))
     (gnus-group-mail-5-empty ((,class (:foreground ,comment :weight normal))))
     (gnus-group-mail-6 ((,class (:foreground ,blue :weight normal))))
     (gnus-group-mail-6-empty ((,class (:foreground ,comment :weight normal))))
     ...
     (gnus-group-news-1-empty ((,class (:foreground ,comment :weight normal))))
     (gnus-group-news-2 ((,class (:foreground ,purple :weight normal))))
     (gnus-group-news-2-empty ((,class (:foreground ,comment :weight normal))))
     (gnus-group-news-3 ((,class (:foreground ,aqua :weight normal))))
     (gnus-group-news-3-empty ((,class (:foreground ,comment :weight normal))))
     (gnus-group-news-4 ((,class (:foreground ,yellow :weight normal))))
     (gnus-group-news-4-empty ((,class (:foreground ,comment :weight normal))))
     (gnus-group-news-5 ((,class (:foreground ,orange :weight normal))))
     (gnus-group-news-5-empty ((,class (:foreground ,comment :weight normal))))
     (gnus-group-news-6 ((,class (:foreground ,blue :weight normal))))
     (gnus-group-news-6-empty ((,class (:foreground ,comment :weight normal))))
