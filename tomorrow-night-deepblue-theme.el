...
(quote
 `(;; Standard font lock faces
   ...
   (markdown-code-face ((,class (:foreground ,foreground :background ,current-line :extend t))))
   (markdown-inline-code-face ((,class (:foreground ,foreground :background ,current-line))))
